...
function create(name, species, genderIndex, primaryColor, earFinnColor, bellyColor, dorsalFinnColor, hairStyle, leafStyle, maneColor, pantsColor, personality, ...)
	...
	leafStyle = wrap(leafStyle, #speciesConfig.leafStyle)
	...
	local identity = {
		...
		facialHairGroup = "leaf",
		facialHairType = speciesConfig.leafStyle[leafStyle+1],
	...
	local parameters = {
		choices = { genderIndex, primaryColor, earFinnColor, bellyColor, dorsalFinnColor, hairStyle, leafStyle, maneColor, pantsColor, personality, ... },
