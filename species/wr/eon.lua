...
function create(name, species, genderIndex, primaryColor, hairStyle, secondaryColor, facialHairStyle, markingsColor, markingsPattern, eyeColor, _8, personality, bellyColor, hairColor, ...)
	...
	local parameters = {
		choices = { genderIndex, primaryColor, hairStyle, secondaryColor, facialHairStyle, markingsColor, markingsPattern, eyeColor, _8, personality, ... },
